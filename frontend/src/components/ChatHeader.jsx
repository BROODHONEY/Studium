  ...
  return (
    <div style={{
      ...
      <button ref={triggerRef}
        ...
        style={{ alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 8, fontSize: 12, fontWeight: 400, border: '1px solid var(--border-color)', background: 'var(--bg-raised)', color: 'var(--text-1)', cursor: 'pointer', flexShrink: 0 }}>
        {activeTab}
